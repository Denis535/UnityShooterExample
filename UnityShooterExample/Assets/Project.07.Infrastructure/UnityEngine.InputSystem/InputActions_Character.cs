...
//     version 1.11.2
//     from Assets/Project.07.Infrastructure/UnityEngine.InputSystem/InputActions_Character.inputactions
//
...
{
    public partial class @InputActions_Character: IInputActionCollection2, IDisposable
    {
        public InputActionAsset asset { get; }
        public @InputActions_Character()
        {
            asset = InputActionAsset.FromJson(@"{
    ""name"": ""InputActions_Character"",
    ""maps"": [
        {
            ""name"": ""Character"",
    ...
    ""controlSchemes"": [
        ...
        ~@InputActions_Character()
        {
            UnityEngine.Debug.Assert(!m_Character.enabled, "This will cause a leak and performance issues, InputActions_Character.Character.Disable() has not been called.");
        }
        ...
        {
            private @InputActions_Character m_Wrapper;
            public CharacterActions(@InputActions_Character wrapper) { m_Wrapper = wrapper; }
